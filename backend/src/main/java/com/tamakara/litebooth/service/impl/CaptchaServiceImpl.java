...
public class CaptchaServiceImpl implements CaptchaService {
    ...
    public CaptchaInfoVO getCaptchaInfoVO() {
        ...
        redisTemplate.opsForValue().set("captcha:" + captchaKey, code, EXPIRE_SECONDS, TimeUnit.SECONDS);
    ...
    public Boolean verifyCaptcha(String captchaKey, String captchaCode) {
        String code = redisTemplate.opsForValue().get("captcha:" + captchaKey);
        if (code == null) return false;
        if (!code.equalsIgnoreCase(captchaCode)) return false;
